...
type CategoryTheme = {
  ...
  btnInactive: React.CSSProperties;
...
const CATEGORY_THEMES: Record<string, CategoryTheme> = {
  Todos: {
    ...
    sidebarTitle: { fontFamily: 'inherit', color: '#DDAF34', letterSpacing: '0.2em' },
    btnActive: { background: '#DDAF34', color: '#000', fontWeight: 700 },
    btnInactive: { background: 'transparent', color: 'rgba(255,255,255,0.5)' },
  ...
  games: {
    ...
    wrapper: {
      background: 'linear-gradient(135deg, #050510 0%, #0d0d25 50%, #050510 100%)',
      color: '#e0e0ff',
    ...
    sidebar: {
      ...
      boxShadow: 'inset -1px 0 20px rgba(123,47,255,0.08)',
    },
    sidebarTitle: { fontFamily: "'Orbitron', sans-serif", color: '#00f5ff', letterSpacing: '0.15em', fontSize: '14px' },
    btnActive: {
    ...
    headerTitle: {
      fontFamily: "'Orbitron', sans-serif",
      color: '#00f5ff',
      textShadow: '0 0 30px rgba(0,245,255,0.5), 0 0 60px rgba(123,47,255,0.3)',
  ...
  religioso: {
    fontImport: 'https://fonts.googleapis.com/css2?family=Cinzel:wght@400;600;700&family=Cormorant+Garamond:ital,wght@0,300;1,300&display=swap',
    wrapper: {
      background: 'linear-gradient(160deg, #f5f0e8 0%, #ede5d0 40%, #f0ead8 100%)',
      color: '#3a2a0a',
      transition: 'all 0.6s ease',
    },
    sidebar: {
      background: 'rgba(237,229,208,0.9)',
      borderRight: '1px solid rgba(139,105,20,0.25)',
    },
    sidebarTitle: { fontFamily: "'Cinzel', serif", color: '#5c3d0e', letterSpacing: '0.25em', fontSize: '13px' },
    btnActive: {
      background: '#8B6914',
      color: '#fff5e0',
    ...
    headerSub: { color: '#a07840', fontFamily: "'Cormorant Garamond', serif", fontStyle: 'italic', fontSize: '16px' },
    accent: '#8B6914',
    bgDecorClass: 'theme-religioso',
    label: 'RELIGIOSO',
    tagline: 'Fé · Devoção · Arte Sacra',
  },
  keycaps: {
    fontImport: 'https://fonts.googleapis.com/css2?family=Chakra+Petch:wght@400;600;700&display=swap',
    wrapper: {
      background: '#f8f4ff',
      color: '#2d1a4a',
      transition: 'all 0.6s ease',
    ...
    sidebar: {
      background: 'rgba(237,230,255,0.95)',
      borderRight: '1px solid rgba(124,58,237,0.2)',
    },
    sidebarTitle: { fontFamily: "'Chakra Petch', sans-serif", color: '#6b21a8', letterSpacing: '0.2em', fontSize: '13px' },
    btnActive: {
      background: '#7c3aed',
      color: '#fff',
    ...
    headerSub: { color: '#a855f7', fontFamily: "'Chakra Petch', sans-serif", fontSize: '12px', letterSpacing: '0.3em' },
    accent: '#7c3aed',
    bgDecorClass: 'theme-keycaps',
    label: 'KEYCAPS',
    tagline: 'ARTISANS · CUSTOM · LIMITED',
  },
  personalizado: {
    fontImport: 'https://fonts.googleapis.com/css2?family=Permanent+Marker&display=swap',
    wrapper: {
    ...
    sidebar: {
      ...
      borderRight: '1.5px dashed rgba(249,115,22,0.35)',
    },
    sidebarTitle: { fontFamily: "'Permanent Marker', cursive", color: '#b45309', letterSpacing: '0.05em', fontSize: '17px' },
    btnActive: {
      background: '#f97316',
      color: '#fff',
    ...
    headerSub: { color: '#f97316', fontFamily: "'Permanent Marker', cursive", fontSize: '16px' },
    accent: '#f97316',
    bgDecorClass: 'theme-personalizado',
    label: 'PERSONALIZADO',
    tagline: 'Único como você ✦',
  },
  lifestyle: {
    fontImport: 'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,600;1,300&display=swap',
    wrapper: {
      background: 'linear-gradient(160deg, #f0f7f0 0%, #e4f0e4 60%, #eef5ee 100%)',
      color: '#14532d',
      transition: 'all 0.6s ease',
    },
    sidebar: {
      background: 'rgba(228,240,228,0.95)',
      borderRight: '1px solid rgba(34,197,94,0.25)',
    },
    sidebarTitle: { fontFamily: "'Cormorant Garamond', serif", color: '#14532d', letterSpacing: '0.2em', fontSize: '15px', fontStyle: 'italic' },
    btnActive: {
      background: '#16a34a',
      color: '#f0fdf4',
    ...
    headerSub: { color: '#22c55e', fontFamily: "'Cormorant Garamond', serif", fontStyle: 'italic', fontSize: '16px' },
    accent: '#16a34a',
    bgDecorClass: 'theme-lifestyle',
    label: 'Lifestyle',
    tagline: 'Design que transforma ambientes',
  },
  outros: {
    fontImport: 'https://fonts.googleapis.com/css2?family=Rajdhani:wght@400;600;700&display=swap',
    wrapper: {
    ...
    sidebarTitle: { fontFamily: "'Rajdhani', sans-serif", color: '#e94560', letterSpacing: '0.25em', fontSize: '14px', fontWeight: 700 },
    btnActive: {
      background: '#e94560',
      color: '#fff',
    ...
    headerSub: { color: '#f5a623', fontFamily: "'Rajdhani', sans-serif", fontSize: '13px', letterSpacing: '0.3em' },
    accent: '#e94560',
    bgDecorClass: 'theme-outros',
    label: 'OUTROS',
      ...
      <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none', opacity: 0.6 }} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="bg-todos" width="60" height="60" patternUnits="userSpaceOnUse">
            <path d="M60 0L0 0 0 60" fill="none" stroke="rgba(221,175,52,0.06)" strokeWidth="1"/>
          </pattern>
        </defs>
        <rect width="100%" height="100%" fill="url(#bg-todos)"/>
      </svg>
    ),
    games: (
      <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none' }} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <radialGradient id="g1" cx="75%" cy="15%" r="45%">
            <stop offset="0%" stopColor="rgba(123,47,255,0.18)"/>
            <stop offset="100%" stopColor="transparent"/>
          </radialGradient>
          <radialGradient id="g2" cx="20%" cy="80%" r="38%">
            <stop offset="0%" stopColor="rgba(0,245,255,0.12)"/>
            <stop offset="100%" stopColor="transparent"/>
          </radialGradient>
        </defs>
        ...
        {[80,180,280,380,480,580].map((y,i) => (
          <line key={i} x1="0" y1={y} x2="100%" y2={y} stroke={i%2===0?"rgba(0,245,255,0.06)":"rgba(123,47,255,0.06)"} strokeWidth="1"/>
        ))}
        {[100,200,350,500,650].map((x,i) => (
          <line key={i} x1={x} y1="0" x2={x} y2="100%" stroke="rgba(0,245,255,0.04)" strokeWidth="1"/>
        ))}
      </svg>
    ),
    religioso: (
      <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none' }} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="bg-cross" width="70" height="70" patternUnits="userSpaceOnUse">
            <line x1="35" y1="12" x2="35" y2="58" stroke="rgba(139,105,20,0.1)" strokeWidth="1"/>
            <line x1="18" y1="28" x2="52" y2="28" stroke="rgba(139,105,20,0.1)" strokeWidth="1"/>
          </pattern>
        </defs>
        <rect width="100%" height="100%" fill="url(#bg-cross)"/>
        <ellipse cx="15%" cy="30%" rx="200" ry="200" fill="rgba(139,105,20,0.04)"/>
        <ellipse cx="85%" cy="70%" rx="150" ry="150" fill="rgba(139,105,20,0.04)"/>
      </svg>
    ),
    keycaps: (
      <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none' }} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="bg-keys" width="55" height="55" patternUnits="userSpaceOnUse">
            <rect x="6" y="6" width="20" height="20" rx="4" fill="none" stroke="rgba(124,58,237,0.12)" strokeWidth="1"/>
            <rect x="30" y="6" width="20" height="20" rx="4" fill="none" stroke="rgba(168,85,247,0.08)" strokeWidth="1"/>
            <rect x="6" y="30" width="20" height="20" rx="4" fill="none" stroke="rgba(168,85,247,0.08)" strokeWidth="1"/>
            <rect x="30" y="30" width="20" height="20" rx="4" fill="none" stroke="rgba(124,58,237,0.12)" strokeWidth="1"/>
          </pattern>
        </defs>
        <rect width="100%" height="100%" fill="url(#bg-keys)"/>
      </svg>
    ),
    personalizado: (
      <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none' }} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="bg-dots" width="28" height="28" patternUnits="userSpaceOnUse">
            <circle cx="14" cy="14" r="1.5" fill="rgba(249,115,22,0.15)"/>
          </pattern>
        </defs>
        <rect width="100%" height="100%" fill="url(#bg-dots)"/>
        <circle cx="85%" cy="20%" r="180" fill="none" stroke="rgba(249,115,22,0.07)" strokeWidth="2"/>
        <circle cx="15%" cy="75%" r="120" fill="none" stroke="rgba(249,115,22,0.05)" strokeWidth="2"/>
      </svg>
    ),
    lifestyle: (
      <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none' }} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="bg-leaf" width="90" height="90" patternUnits="userSpaceOnUse">
            <ellipse cx="22" cy="45" rx="10" ry="22" fill="none" stroke="rgba(34,197,94,0.1)" strokeWidth="1" transform="rotate(-30 22 45)"/>
            <ellipse cx="68" cy="22" rx="8" ry="18" fill="none" stroke="rgba(22,163,74,0.08)" strokeWidth="1" transform="rotate(25 68 22)"/>
            <ellipse cx="68" cy="68" rx="9" ry="20" fill="none" stroke="rgba(34,197,94,0.08)" strokeWidth="1" transform="rotate(-15 68 68)"/>
          </pattern>
        </defs>
      ...
      <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none' }} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <radialGradient id="og1" cx="50%" cy="50%" r="60%">
            <stop offset="0%" stopColor="rgba(233,69,96,0.08)"/>
            <stop offset="100%" stopColor="transparent"/>
          </radialGradient>
        </defs>
        <rect width="100%" height="100%" fill="url(#og1)"/>
        <circle cx="80%" cy="18%" r="140" fill="none" stroke="rgba(233,69,96,0.1)" strokeWidth="1"/>
        <circle cx="80%" cy="18%" r="90" fill="none" stroke="rgba(245,166,35,0.08)" strokeWidth="1"/>
        <circle cx="80%" cy="18%" r="45" fill="none" stroke="rgba(233,69,96,0.12)" strokeWidth="1"/>
        <circle cx="18%" cy="78%" r="110" fill="none" stroke="rgba(245,166,35,0.07)" strokeWidth="1"/>
        <circle cx="18%" cy="78%" r="65" fill="none" stroke="rgba(233,69,96,0.08)" strokeWidth="1"/>
      </svg>
    ),
  };
...
const SEARCH_STOP_WORDS = new Set([
  'a','o','e','de','do','da','dos','das','em','no','na','nos','nas','para',
  'com','por','um','uma','uns','umas','ao','aos','as','os',
]);
...
const RELATED_SEARCH_TERMS: Record<string, string[]> = {
  ...
  deadpool: ['dead pool','wade','anti heroi','anti-heroi','anti herói','anti-herói','suporte headset','headset'],
  resident: ['resident evil','residente evil','resid evil','umbrella','umbrella corporation','controle','ps5','xbox','pro controller','controller'],
  evil: ['resident evil','umbrella'],
  umbrella: ['resident evil','residente evil'],
  varinha: ['magia','magica','mágica','harry','bruxo','bruxa','cartao','cartão','porta cartao','porta cartão','pagamento'],
...
const getCategoryIntent = (term: string) => {
  ...
  for (const [category, terms] of Object.entries(CATEGORY_SEARCH_INTENTS)) {
    ...
    const hasIntent = normalizedTerms.some(item => {
      ...
      return (query === item || query.includes(item) || item.includes(query) ||
...
const expandSearchPhrases = (term: string) => {
  ...
  Object.entries(RELATED_SEARCH_TERMS).forEach(([main, aliases]) => {
    ...
    if (shouldExpand) group.forEach(item => phrases.add(item));
  });
    ...
    if (shouldExpand) {
      group.forEach(item => {
        getSearchWords(item).forEach(word => {
          if (word.length >= 3 && !SEARCH_STOP_WORDS.has(word)) expanded.add(word);
        });
      });
    }
  });
...
const getSearchScore = (product: Product, searchTerm: string) => {
  ...
  if (categoryIntent) {
    if (productCategory === categoryIntent) score += 140;
    else score -= 180;
  }
  ...
  searchWords.forEach(word => {
    ...
    if (exactTitleWord) score += 90;
    else if (title.includes(word)) score += 70;
    else if (exactTextWord) score += 55;
    else if (text.includes(word)) score += 35;
    else {
      const bestDistance = productWords.reduce((best, current) => Math.min(best, levenshteinDistance(word, current)), 99);
      const maxDistance = word.length <= 4 ? 1 : word.length <= 7 ? 2 : 3;
      if (bestDistance <= maxDistance) score += 28;
    }
  });
  specificWords.forEach(word => {
    if (wordMatchesProduct(word, productWords, text, title)) matchedSpecificWords += 1;
  });
  if (categoryIntent && specificWords.length > 0 && matchedSpecificWords === 0) return 0;
  if (!categoryIntent && searchWords.length > 0) {
    const matchedWords = searchWords.filter(word => wordMatchesProduct(word, productWords, text, title)).length;
    if (matchedWords === 0) return 0;
    if (searchWords.length >= 2 && matchedWords === 1) score -= 25;
  }
  return score;
};
    ...
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <button onClick={onOpenAuth} className="text-freo-light hover:text-freo-orange transition-colors" aria-label="Minha conta">
...
const Hero = ({ setCurrentView }: any) => (
  <section className="relative min-h-screen flex items-center overflow-hidden bg-[#080808]">
    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-10 items-center relative z-10 w-full pt-28 pb-12 min-h-screen">
      ...
      <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.85, delay: 0.2 }} className="relative h-[480px] lg:h-[660px] hidden lg:flex items-center justify-center">
    ...
    if (!isLogin) {
      ...
      try {
        ...
        if (error) {
          ...
          if (message.includes('rate limit')) message = 'Limite de envios excedido. Tente mais tarde.';
          else if (message.includes('already registered')) message = 'Este e-mail já está cadastrado.';
          setError(message);
        } else {
          setSuccess(true);
      ...
      try {
        ...
        if (error) {
          ...
          else if (message === 'Email not confirmed') message = 'Confirme seu email antes de fazer login.';
          setError(message);
        } else {
          setSuccess(true);
          setTimeout(() => { onClose(); window.location.href = '/dashboard.html'; }, 1500);
        }
      } catch { setError('Erro de conexão. Tente novamente.'); } finally { setLoading(false); }
    }
  };
  ...
  useEffect(() => {
    const handleAuthData = (event: any) => {
      ...
      if (event.detail.cartItems) {
        setCartItems(event.detail.cartItems.map((item: any) => ({
          cartItemId: item.id,
