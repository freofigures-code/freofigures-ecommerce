  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10 w-full">
        ...
        >
          {/* Abstract 3D Representation - using a stylized image with floating elements */}
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative w-full max-w-md aspect-square">
              ...
              <motion.div 
                ...
                className="absolute inset-0 border border-freo-orange/30 rounded-full border-dashed"
              ></motion.div>
              <motion.div 
                animate={{ rotate: -360 }} 
                transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
                className="absolute inset-4 border border-freo-cyan/20 rounded-full"
              ></motion.div>
              ...
              <img 
                ...
                alt="3D Printed Vase" 
                className="absolute inset-8 object-cover rounded-full z-10 shadow-[0_0_50px_rgba(255,77,0,0.3)]"
              ...
              <motion.div 
                ...
                className="absolute top-10 -right-10 bg-freo-dark border border-white/10 p-4 rounded-xl z-20 backdrop-blur-md flex items-center gap-3 shadow-xl"
              >
                <Layers className="text-freo-orange w-6 h-6" />
                <div>
                  <div className="text-xs text-freo-light/50 uppercase font-bold tracking-wider">Resolução</div>
                  <div className="font-display font-bold">0.05mm</div>
                </div>
              </motion.div>
              ...
              <motion.div 
                ...
                className="absolute bottom-20 -left-10 bg-freo-dark border border-white/10 p-4 rounded-xl z-20 backdrop-blur-md flex items-center gap-3 shadow-xl"
              >
                <Box className="text-freo-cyan w-6 h-6" />
                <div>
                  <div className="text-xs text-freo-light/50 uppercase font-bold tracking-wider">Material</div>
                  <div className="font-display font-bold">PLA Silk Premium</div>
                </div>
              </motion.div>
            </div>
          </div>
...
const FeaturedProducts = ({ addToCart }: any) => {
  const products = [
    { name: "Escultura Voldemort Lorde das Trevas", price: "R$ 120,65", cat: "Geek", img: "https://images.unsplash.com/photo-1618944847023-38aa001235f0?q=80&w=800&auto=format&fit=crop", tag: "Premium" },
    { name: "Nossa Senhora Porta Água Benta", price: "R$ 12,59", cat: "Religioso", img: "https://images.unsplash.com/photo-1544383835-bca2bc6f5fc4?q=80&w=800&auto=format&fit=crop", tag: "Mais Vendido" },
    { name: "Suporte Controle PS4 God of War", price: "R$ 69,00", cat: "Geek", img: "https://images.unsplash.com/photo-1507457379470-08b800bebc67?q=80&w=800&auto=format&fit=crop" },
    { name: "Porta Lata Monster Energy Ajustável", price: "R$ 53,00", cat: "Utensílios", img: "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?q=80&w=800&auto=format&fit=crop", tag: "Novo" },
  ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {products.map((prod, i) => (
            <div key={i} className="group flex flex-col">
              <div className="relative aspect-square bg-freo-black mb-4 overflow-hidden border border-white/5 group-hover:border-freo-orange/50 transition-colors">
                {prod.tag && (
                  <div className="absolute top-4 left-4 z-10 bg-freo-orange text-freo-black text-xs font-bold uppercase tracking-widest px-2 py-1">
                    {prod.tag}
                  </div>
                )}
                <img 
              ...
              <div className="flex flex-col flex-grow">
                <span className="text-freo-orange text-xs font-mono uppercase mb-1">{prod.cat}</span>
                <h3 className="text-lg font-display font-bold leading-tight mb-2 group-hover:text-freo-orange transition-colors">{prod.name}</h3>
                <div className="mt-auto flex flex-col gap-4">
                  <div className="font-mono text-xl font-bold text-freo-orange">{prod.price}</div>
                  <button onClick={() => addToCart(prod)} className="w-full bg-freo-orange text-freo-black font-display font-bold uppercase tracking-wider py-3 hover:bg-white transition-colors flex items-center justify-center gap-2">
                    <ShoppingCart className="w-5 h-5" />
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        <div className="order-2 lg:order-1 relative">
          <div className="aspect-[4/5] bg-freo-dark border border-white/10 relative overflow-hidden">
            <img 
              src="https://images.unsplash.com/photo-1631541909061-71e34ddde0de?q=80&w=800&auto=format&fit=crop" 
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row gap-16 items-start">
          ...
          <div className="md:w-1/3 md:sticky md:top-32">
            ...
            {/* Optional image/avatar placeholder for the founder */}
          ...
          <div className="md:w-2/3 space-y-8 font-body text-lg text-freo-light/80 leading-relaxed">
            ...
            <p>
              A Freo Figures começou com uma máquina, um rolo de filamento e uma inquietação:<br/>
              <span className="text-freo-orange font-medium italic">“E se eu puder criar exatamente o que eu imagino?”</span>
            </p>

            <p>
              Eu não comecei isso pensando em abrir empresa.<br/>
            ...
            <p>
              No começo deu errado várias vezes. Peça que não saía como eu queria. Ideia que na cabeça era incrível e na prática não funcionava. Gente dizendo que era melhor vender coisa pronta, mais fácil, mais seguro.
            </p>

            <p className="font-bold text-white">
              Mas nunca foi sobre o mais fácil.
            </p>

            <p>
              Foi sobre olhar pra algo que não existe ainda e pensar: <br/>
              <span className="text-freo-cyan font-medium italic">“Eu consigo criar isso.”</span>
            </p>

            <p>
              A Freo Figures é pequena. E eu gosto disso.
            </p>

            <p>
              Porque aqui nada é automático. Nada é feito no piloto automático. Cada produto que você vê aqui passou pela minha mão. Passou por dúvida. Passou por ajuste. Passou por insistência.
            </p>

            <p>
              Eu poderia ter escolhido algo mais simples. Mas escolhi criar. E criar dá trabalho. Mas também dá orgulho.
            </p>
            ...
            <div className="bg-freo-dark p-8 border border-white/5 mt-12 relative">
              ...
              <p className="font-display text-xl text-white">
                Então, mais do que comprar uma peça, você está apoiando alguém que decidiu construir algo do zero.<br/>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <img src="https://rrmxqpvxrpcqqxsgccqw.supabase.co/storage/v1/object/public/imagens/logo.jpg" alt="Freo Figures Logo" className="w-10 h-10 rounded-full object-cover border-2 border-freo-orange" />
              <span className="font-display font-black text-2xl tracking-tighter uppercase">
                Freo<span className="text-freo-orange font-light">Figures</span>
              </span>
            </div>
            <p className="text-freo-light/60 font-body text-sm mb-6">
              Transformando filamento em arte. Especialistas em impressão 3D de alta qualidade para colecionadores, devotos e amantes do design.
            </p>
  ...
  return (
    <section className="py-24 px-6 bg-freo-orange text-freo-black relative overflow-hidden border-y border-freo-orange/50">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center">
        <img src="https://rrmxqpvxrpcqqxsgccqw.supabase.co/storage/v1/object/public/imagens/logo.jpg" alt="Freo Figures Logo" className="w-24 h-24 rounded-full object-cover border-4 border-freo-black mb-6 shadow-2xl" />
        <h2 className="text-5xl md:text-7xl font-display font-black uppercase tracking-tighter mb-6 leading-none">
          Acesse o <br/> Catálogo Completo
        </h2>
        <p className="font-body text-xl mb-10 font-medium max-w-2xl">
          Filtre por categorias, explore detalhes e encontre a peça perfeita para o seu setup, altar ou estante. Tudo feito sob demanda.
        </p>
        <button 
          onClick={() => {
            setCurrentView('shop');
...
const ShopView = ({ addToCart }: any) => {
  ...
  const categories = ['Todos', 'Geek', 'Religioso', 'Utensílios', 'Decoração'];
  
  const allProducts = [
    // Religioso
    { name: "Nossa Senhora Porta Água Benta", price: "R$ 12,59", cat: "Religioso", img: "https://images.unsplash.com/photo-1544383835-bca2bc6f5fc4?q=80&w=800&auto=format&fit=crop", tag: "Mais Vendido" },
    { name: "Busto Sagrado Coração de Jesus", price: "R$ 22,00", cat: "Religioso", img: "https://images.unsplash.com/photo-1580130281320-0ef0754f2bf7?q=80&w=800&auto=format&fit=crop" },
    { name: "Pia de Água Benta Anjo Querubim", price: "R$ 29,00", cat: "Religioso", img: "https://images.unsplash.com/photo-1606046604972-77cc76aee944?q=80&w=800&auto=format&fit=crop" },
    { name: "Porta Água Benta Clássico 18cm", price: "R$ 69,00", cat: "Religioso", img: "https://images.unsplash.com/photo-1572889613618-970e7041e124?q=80&w=800&auto=format&fit=crop" },
    { name: "Imagem de Jesus Cristo em Busto", price: "R$ 48,00", cat: "Religioso", img: "https://images.unsplash.com/photo-1583089892943-e02e52f17d05?q=80&w=800&auto=format&fit=crop" },
    { name: "Escultura Jesus Cristo em Relevo", price: "R$ 34,00", cat: "Religioso", img: "https://images.unsplash.com/photo-1502083896352-259ab9e342d7?q=80&w=800&auto=format&fit=crop" },

    // Geek / Setup
    { name: "Keycap Valorant Premium", price: "R$ 23,00", cat: "Geek", img: "https://images.unsplash.com/photo-1595225476474-87563907a212?q=80&w=800&auto=format&fit=crop" },
    { name: "Kit Keycaps Minecraft", price: "R$ 13,00", cat: "Geek", img: "https://images.unsplash.com/photo-1607853202273-797f1c22a38e?q=80&w=800&auto=format&fit=crop" },
    { name: "Kit 5 Keycaps CS Premium", price: "R$ 15,00", cat: "Geek", img: "https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?q=80&w=800&auto=format&fit=crop" },
    { name: "Resident Evil Logo Umbrella 3D", price: "R$ 27,00", cat: "Geek", img: "https://images.unsplash.com/photo-1608889175123-8ee362201f81?q=80&w=800&auto=format&fit=crop" },
    { name: "Suporte Controle PS4 God of War", price: "R$ 69,00", cat: "Geek", img: "https://images.unsplash.com/photo-1507457379470-08b800bebc67?q=80&w=800&auto=format&fit=crop" },
    { name: "Suporte Controle Resident Evil", price: "R$ 57,00", cat: "Geek", img: "https://images.unsplash.com/photo-1600080972464-8e5f35f63d08?q=80&w=800&auto=format&fit=crop" },
    { name: "Escultura Voldemort Lorde das Trevas", price: "R$ 120,65", cat: "Geek", img: "https://images.unsplash.com/photo-1618944847023-38aa001235f0?q=80&w=800&auto=format&fit=crop", tag: "Premium" },
    { name: "Marcadores de Página Harry Potter", price: "R$ 16,00", cat: "Geek", img: "https://images.unsplash.com/photo-1511251459011-b47271112654?q=80&w=800&auto=format&fit=crop" },
    { name: "Suporte Controle Xbox Series Almofada", price: "R$ 57,00", cat: "Geek", img: "https://images.unsplash.com/photo-1605901309584-818e25960b8f?q=80&w=800&auto=format&fit=crop" },

    // Utensílios
    { name: "Carteira Slim Minimalista", price: "R$ 17,00", cat: "Utensílios", img: "https://images.unsplash.com/photo-1627123424574-724758594e93?q=80&w=800&auto=format&fit=crop" },
    { name: "Porta Lata Monster Energy Ajustável", price: "R$ 53,00", cat: "Utensílios", img: "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?q=80&w=800&auto=format&fit=crop" },
    { name: "Varinha Porta Cartão Carnaval", price: "R$ 46,00", cat: "Utensílios", img: "https://images.unsplash.com/photo-1563298723-dcfebaa392e3?q=80&w=800&auto=format&fit=crop" },
    { name: "Chaveiro Camisa do Brasil", price: "R$ 17,00", cat: "Utensílios", img: "https://images.unsplash.com/photo-1614027164847-1b28cfe1df60?q=80&w=800&auto=format&fit=crop" },
    { name: "Capinha Case AirPods 1 2 3 Pro", price: "R$ 17,00", cat: "Utensílios", img: "https://images.unsplash.com/photo-1603351154351-5e2d0600bb77?q=80&w=800&auto=format&fit=crop" },
    { name: "Suporte Câmera Tapo C200 Parede", price: "R$ 23,00", cat: "Utensílios", img: "https://images.unsplash.com/photo-1557825835-b454ce46f525?q=80&w=800&auto=format&fit=crop" },
    { name: "Chaveiro Personalizado com Nome", price: "R$ 13,00", cat: "Utensílios", img: "https://images.unsplash.com/photo-1584432810601-6c7f27d2362b?q=80&w=800&auto=format&fit=crop" },

    // Decoração
    { name: "Incensário Redondo Minimalista", price: "R$ 37,00", cat: "Decoração", img: "https://images.unsplash.com/photo-1602928321679-560bb453f190?q=80&w=800&auto=format&fit=crop" },
    { name: "Incensário Mão de Fátima Hamsá", price: "R$ 29,00", cat: "Decoração", img: "https://images.unsplash.com/photo-1519892300165-cb5542fb47c7?q=80&w=800&auto=format&fit=crop" },
    { name: "Chaveiro Taça Copa do Mundo", price: "R$ 18,00", cat: "Decoração", img: "https://images.unsplash.com/photo-1579952363873-27f3bade9f55?q=80&w=800&auto=format&fit=crop" },
  ];

  const filtered = activeFilter === 'Todos' ? allProducts : allProducts.filter(p => p.cat === activeFilter);
            ...
            <div className="space-y-2">
              {categories.map(cat => (
                <button 
                  ...
                  className={`block w-full text-left px-4 py-3 font-mono text-sm uppercase tracking-widest transition-all ${activeFilter === cat ? 'bg-freo-orange text-freo-black font-bold' : 'text-freo-light/60 hover:text-freo-orange hover:bg-white/5'}`}
                >
        ...
        <div className="md:w-3/4">
          <div className="mb-8 flex justify-between items-end border-b border-white/10 pb-4">
            <div className="font-mono text-freo-light/50 text-sm">
              Mostrando {filtered.length} resultados para <span className="text-freo-orange">[{activeFilter}]</span>
            </div>
          </div>
            ...
            <AnimatePresence>
              {filtered.map((prod, i) => (
                <motion.div 
                  ...
                  key={prod.name} 
                  className="group flex flex-col bg-freo-dark border border-white/5 hover:border-freo-orange/50 transition-colors"
                >
                  <div className="relative aspect-square bg-freo-black overflow-hidden">
                    {prod.tag && (
                    ...
                    <img 
                      ...
                      referrerPolicy="no-referrer"
                    />
                    <div className="absolute inset-0 bg-freo-orange/20 opacity-0 group-hover:opacity-100 mix-blend-overlay transition-opacity duration-300"></div>
                  </div>
                  
                  <div className="p-5 flex flex-col flex-grow">
                    <span className="text-freo-orange text-[10px] font-mono uppercase mb-2 tracking-wider">{prod.cat}</span>
                    <h3 className="text-lg font-display font-bold leading-tight mb-4 group-hover:text-freo-orange transition-colors">{prod.name}</h3>
                    <div className="mt-auto flex flex-col gap-4">
                      <div className="font-mono text-xl font-bold text-freo-orange">{prod.price}</div>
                      <button onClick={() => addToCart(prod)} className="w-full bg-freo-orange text-freo-black font-display font-bold uppercase tracking-wider py-3 hover:bg-white transition-colors flex items-center justify-center gap-2">
                        <ShoppingCart className="w-5 h-5" />
      ...
      try {
        ...
        if (error) {
          ...
          if (errorMessage.includes('rate limit')) {
            errorMessage = 'Limite de envios de e-mail excedido. Tente novamente mais tarde.';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
          ...
          >
            ...
            <button onClick={onClose} className="absolute top-4 right-4 text-freo-light/50 hover:text-white transition-colors">
              <X className="w-6 h-6" />
            </button>

            <div className="p-8">
              <div className="flex justify-center mb-8">
                <img src="https://rrmxqpvxrpcqqxsgccqw.supabase.co/storage/v1/object/public/imagens/logo.jpg" alt="Freo Figures Logo" className="w-16 h-16 rounded-full object-cover border-2 border-freo-orange shadow-[0_0_15px_rgba(221,175,52,0.3)]" />
              </div>
              ...
              <p className="text-freo-light/60 text-center font-body text-sm mb-8">
                {isLogin ? 'Entre para acompanhar seus pedidos e projetos.' : 'Junte-se à revolução da manufatura aditiva.'}
              </p>
              ...
              {success ? (
                <div className="bg-freo-cyan/10 border border-freo-cyan text-freo-cyan p-6 text-center font-mono text-sm mb-6 flex flex-col items-center gap-3">
                  <svg className="w-8 h-8 text-freo-cyan" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span>
                    {isLogin 
                      ? 'Login realizado com sucesso!' 
                      : '✅ Conta criada com sucesso! Verifique seu email agora para continuar.'}
                  </span>
                </div>
              ) : (
                <div className="space-y-4">
                  <button className="w-full flex items-center justify-center gap-3 bg-white text-freo-black font-bold py-3 hover:bg-freo-light transition-colors">
                  ...
                  <div className="relative flex items-center py-2">
                    ...
                    <span className="flex-shrink-0 mx-4 text-freo-light/40 text-xs font-mono uppercase">Ou use seu e-mail</span>
                    <div className="flex-grow border-t border-white/10"></div>
                  </div>
      ...
      {isOpen && (
        <>
          ...
          <motion.div 
            ...
            className="fixed top-0 right-0 h-full w-full sm:w-[400px] bg-freo-dark border-l border-white/10 z-[101] shadow-2xl flex flex-col"
          >
            ...
            {cartItems.length > 0 && (
              <div className="p-6 border-t border-white/10 bg-freo-black">
                ...
                <button className="w-full bg-freo-orange text-freo-black font-bold font-display uppercase tracking-widest py-4 hover:bg-white transition-colors">
                  Finalizar Compra
                </button>
              </div>
            )}
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Initial check just in case the event fired before React mounted
    // @ts-ignore
    ...
    return () => {
      ...
      window.removeEventListener('auth-not-logged-in', handleAuthNotLoggedIn);
    };
  }, []);
  ...
  const addToCart = async (product: any) => {
    ...
    try {
      ...
      // Update local state so header icon updates
      setCartItems(prev => {
