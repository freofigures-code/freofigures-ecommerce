...
.ff-mini-av { width: 26px; height: 26px; border-radius: 50%; overflow: hidden; flex-shrink: 0; background: #DDAF34; }
.ff-bubble { max-width: 210px; padding: 9px 12px; font-size: 12.5px; line-height: 1.55; word-break: break-word; }
.ff-bubble-in { background: #181818; border: 1px solid rgba(221,175,52,0.1); border-radius: 14px 14px 14px 3px; color: #f0efeb; }
.ff-bubble-out { background: #DDAF34; color: #0e0e0f; font-weight: 500; border-radius: 14px 14px 3px 14px; }
...
.ff-callout-name { font-size: 10px; font-weight: 700; color: #DDAF34; letter-spacing: 0.04em; line-height: 1; display: flex; align-items: center; gap: 4px; }
